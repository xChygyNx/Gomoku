...
from constants import BACKGROUND_COLOR, BOARD_COLOR


class Board:

    def __init__(self, win, cells=19):
        self._win = win
        self._cells = cells
        self._b_width = win.winfo_height() - 35
        self._padding = 50
    ...
    def print_board(self):
        ...
        self._canvas = ttk.Canvas(self._frame, width=self._b_width, height=self._b_width, bg=BOARD_COLOR)
